...
module MjmlRb
  # Comprehensive mapping of HTML named character references to their Unicode
  # codepoints.  Used by the parser to convert HTML entities into XML-safe
  # numeric character references (e.g. &nbsp; -> &#160;) before feeding the
  # document to the strict XML parser.
  #
  # Only entities that differ from the five XML predefined entities (amp, lt,
  # gt, quot, apos) need to be listed here — those are handled separately.
  HTML_ENTITIES = {
    # Latin-1 Supplement
    ...
    # C0 Controls and Basic Latin (fnof)
    "fnof"     => 402
  }.freeze
end
